...
const categories = ['All', 'Business Intelligence', 'Exploratory Data Analysis'];
    ...
    <section id="projects" className="py-24 relative z-10 bg-[#070913]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-wrap items-center justify-center gap-2 mb-12">
          <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-slate-900/80 border border-white/10 text-xs font-mono text-gray-400 mr-2">
          ...
          {categories.map((cat) => (
            <button
              ...
              className={`px-4 py-2 rounded-full text-xs font-mono font-medium transition-all duration-300 ${
                activeCategory === cat
                  ? 'bg-gradient-to-r from-blue-600 to-cyan-600 text-white font-bold shadow-lg shadow-blue-500/25 border border-cyan-400/30'
                  : 'bg-slate-900/60 text-gray-400 hover:text-white hover:bg-slate-800 border border-white/5'
              }`}
            >
              {cat}
            </button>
                    ...
                    <div className="flex items-center gap-3">
                      {project.liveDemo && project.liveDemo !== '#' && (
                        <a
                          ...
                          className="p-2.5 rounded-xl bg-cyan-950/80 text-cyan-300 hover:text-white hover:bg-cyan-900 border border-cyan-500/40 transition-colors"
